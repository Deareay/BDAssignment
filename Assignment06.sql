...
-- 2017-01-01,DElliott,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment06DB_DElliott')
	 Begin 
	  Alter Database [Assignment06DB_DElliott] set Single_user With Rollback Immediate;
	  Drop Database Assignment06DB_DElliott;
	 End
	Create Database Assignment06DB_DElliott;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment06DB_DElliott;
...
ORDER BY InventoryDate, [Employee Name];
go 
